...
import mascotAnalyse from "../assets/mascotte_search.svg";
...
export function AssetLoadingTransition({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#28374D]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  y2="100%"
                >
                  <stop offset="0%" stopColor="#ff7afd" stopOpacity="0.75" />
